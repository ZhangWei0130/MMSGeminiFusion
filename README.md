...
```shell
export PYTHONPATH=/home/b311/data/zhangwei/HALF:$PYTHONPATH

# b2,rgb+d  
CUDA_VISIBLE_DEVICES=0 python -m torch.distributed.launch --master_port 2255 --nproc_per_node=8 --use_env tools/train_mm.py --cfg configs/deliver_rgbd.yaml --drop_path_rate 0.4

# b2,rgb+e  
CUDA_VISIBLE_DEVICES=0 python -m torch.distributed.launch --master_port 2245 --nproc_per_node=8 --use_env tools/train_mm.py --cfg configs/deliver_rgbe.yaml --drop_path_rate 0.4

# b2,rgb+l  
CUDA_VISIBLE_DEVICES=0 python -m torch.distributed.launch --master_port 2235 --nproc_per_node=8 --use_env tools/train_mm.py --cfg configs/deliver_rgbl.yaml --drop_path_rate 0.4

# b2,rgb+d+e+l  
CUDA_VISIBLE_DEVICES=0 python -m torch.distributed.launch --master_port 2225 --nproc_per_node=8 --use_env tools/train_mm.py --cfg configs/deliver_rgbdel.yaml --drop_path_rate 0.2
```
...
# deliver, rgb+d  
CUDA_VISIBLE_DEVICES=0 python tools/val_mm.py --cfg configs/deliver_rgbd.yaml 

# deliver, rgb+e  
CUDA_VISIBLE_DEVICES=0 python tools/val_mm.py --cfg configs/deliver_rgbe.yaml 

# deliver, rgb+l  
CUDA_VISIBLE_DEVICES=0 python tools/val_mm.py --cfg configs/deliver_rgbl.yaml 
...
# mfnet
CUDA_VISIBLE_DEVICES=0 python tools/val_mm.py --cfg configs/mfnet.yaml 

# nyu
CUDA_VISIBLE_DEVICES=0 python tools/val_mm.py --cfg configs/nyu.yaml 

# urbanlf, real_LF8
CUDA_VISIBLE_DEVICES=0 python tools/val_mm.py --cfg configs/urbanlf_real_LF8.yaml 

# urbanlf, real_LF33
CUDA_VISIBLE_DEVICES=0 python tools/val_mm.py --cfg configs/urbanlf_real_LF33.yaml 

# urbanlf, syn_LF8
CUDA_VISIBLE_DEVICES=0 python tools/val_mm.py --cfg configs/urbanlf_syn_LF8.yaml 

# urbanlf, syn_LF33
CUDA_VISIBLE_DEVICES=0 python tools/val_mm.py --cfg configs/urbanlf_syn_LF33.yaml 
```
